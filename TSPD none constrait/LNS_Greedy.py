"""
- This script is used to solve TSPD with Greedy LNS
- Dataset is data was uesd for TSP 
- Script doesn't have constrait of limit drone distance and waiting time between truck and drone 
- Drone is dispatched and doesn't indentify exactly a return location
"""
import numpy as np
import random
...
def main():
    ...
    truck_route, truck_distance = greedy_large_neighborhood_search(distance_matrix, iterations=50, neighborhood_size=4, verbose=True)
